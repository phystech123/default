...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width = 0.3\linewidth]{pictures/2.jpg}
        \includegraphics[width = 0.3\linewidth]{pictures/4.png}
        \includegraphics[width = 0.3\linewidth]{pictures/1.jpg}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width = 0.3\linewidth]{pictures/3.jpg}
    \end{center}
    \caption{Фигуры лиссажу}
\end{figure}
